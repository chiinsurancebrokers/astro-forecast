...
TRANSLATIONS = {
    "en": {
        ...
        "primary_synthesis_label": "Primary Synthesis",
        "verification_label": "Verification",
        "analysis_note": (
            "Claude writes the primary synthesis from the raw data; ChatGPT "
            "then reviews that specific answer and checks it against the "
            "same data — this is a verification pass, not a second "
            "independent opinion."
        ),
        "narrative_title": "Full Narrative Report",
        "narrative_intro_label": "Overview",
        "narrative_practical_notes": "Points to Watch",
        "narrative_conclusion": "Closing Notes",
        "narrative_provider_label": "Written by",
        "narrative_generate": "Generate report",
        "narrative_download_pdf": "Download report as PDF",
        "request_failed": "Something went wrong — the request may have timed out. Please try again.",
        "section_business": "Business",
        "section_career": "Career",
        "section_finance": "Finance",
        "section_relationships": "Relationships",
        "section_general": "Travel & General Notes",
        "areas": {
            "career": "Career",
            "money": "Money",
    ...
    "el": {
        ...
        "claude_label": "Claude",
        "chatgpt_label": "ChatGPT",
        "primary_synthesis_label": "Πρώτη Σύνθεση",
        "verification_label": "Επαλήθευση",
        "analysis_note": (
            "Το Claude γράφει την πρώτη σύνθεση από τα ακατέργαστα "
            "δεδομένα· το ChatGPT στη συνέχεια εξετάζει αυτή τη "
            "συγκεκριμένη απάντηση και την ελέγχει σε σχέση με τα ίδια "
            "δεδομένα — πρόκειται για βήμα επαλήθευσης, όχι για μια "
            "δεύτερη ανεξάρτητη γνώμη."
        ),
        "narrative_title": "Πλήρης Αναλυτική Αναφορά",
        "narrative_intro_label": "Επισκόπηση",
        "narrative_practical_notes": "Σημεία Προσοχής",
        "narrative_conclusion": "Κλείσιμο",
        "narrative_provider_label": "Συντάχθηκε από",
        "narrative_generate": "Δημιουργία αναφοράς",
        "narrative_download_pdf": "Λήψη αναφοράς σε PDF",
        "request_failed": "Κάτι πήγε στραβά — το αίτημα μπορεί να έληξε. Δοκιμάστε ξανά.",
        "section_business": "Επιχείρηση",
        "section_career": "Καριέρα",
        "section_finance": "Οικονομικά",
        "section_relationships": "Σχέσεις",
        "section_general": "Ταξίδια & Γενικές Σημειώσεις",
        "areas": {
            "career": "Καριέρα",
            "money": "Χρήμα",
